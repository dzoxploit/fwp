...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
 ...
 <div class="my-nav">
  ...
  <div class="container-fluid articlenws" style="
     background-image:url('images/bg.jpg'); background-size:100%; height:300px;">
      <h1 class="text-center" style="margin-top:120px; color:white;">News Article</h1>
  </div>
 </div>
    <div class="row">
    ...
    try
    {
        ...
        while($row = $stmt->fetch()){
                echo'<div class="col-lg-11 text-center pull-left>';
                echo'<img src="'.$row['path_image'].'">';
                echo'</div>';
                echo' <div class="col-lg-5 text-center pull-right">';
                echo'<h3><a href="viewpost.php?id='.$row['id_news'].'">'.$row['judul'].'</a></h3>';
                echo'<p>'.$row['deskripsi'].'</p>';
                echo'<h3><a href="viewpost.php?id='.$row['id_news'].'">read more</a></h3>';
                echo'</div>';
        }
